...
export default function HoldingsTable({ holdings, onWatchlistToggle, watchlist = [], onHoldingsUpdate }) {
...
function HoldingActions({ holding, onHoldingsUpdate }) {
...
function WatchlistButton({ assetId, isInWatchlist, onToggle }) {
